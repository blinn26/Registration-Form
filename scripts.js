...
function NextSlide(SlideNo) {
  ...
  console.log(
    parseInt(window.getComputedStyle(document.querySelector('scroller')).getPropertyValue('margin-left')) - 478
  );
  document.querySelector('scroller').style.marginLeft =
    parseInt(window.getComputedStyle(document.querySelector('scroller')).getPropertyValue('margin-left')) - 478 + 'px';
